...
export default function Login(props: any) {
  return (
    <div className="w-screen h-screen grid grid-rows-2">
      <div className="bg-cover-bg bg-cover bg-center"></div>
      <div className="bg-primaryLight px-8">
        <div className="relative max-w-screen-sm -top-20 mx-auto rounded-sm p-12 bg-white text-center">
