...
function Profil(props) {
  ...
  return (
    <>
      <header className="flex flex-wrap justify-center px-8 lg:px-20 py-20">
        <div className="w-full h-80 lg:h-96 bg-cover-bg bg-cover bg-center rounded-3xl rounded-b-none"></div>
        {props.user ? (
            <>
              <div className="flex flex-col items-center">
                <div className="relative w-40 h-40 -mt-20 mb-4 rounded-full bg-cover bg-center border-4 border-white overflow-hidden flex-shrink-0">
                  <img
                ...
                <div className="flex-auto truncate text-center">
                  <h1 className="font-title font-semibold text-heading text-black truncate">
                    {props.user.userData.displayName}
                  </h1>
                  <p className="whitespace-normal text-sm text-gray-700 uppercase tracking-wider font-medium mb-8">
